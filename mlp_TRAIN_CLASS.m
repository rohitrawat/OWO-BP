function [E] = mlp_TRAIN_CLASS(training_file, N, M, Nh, Nit, lambda, cascade, different_weights_filename)
...
%
%   See also mlp_PROCESSING_CLASS, mlp_TRAIN, and, mlp_PROCESSING.
...
% an Nv by (N+M) matrix
[x ic Nv] = read_class_file(training_file, N, M);

classifier_mode = true;
[E Wi Wo] = mlp_train_data(x, ic, N, M, Nh, Nit, lambda, cascade, classifier_mode);
